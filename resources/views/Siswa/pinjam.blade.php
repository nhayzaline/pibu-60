                ...
                <div class="main-card shadow-sm">
                    <div class="info-banner">
                        ...
                        <div>
                            ...
                            <small class="text-muted" style="font-size: 10px;">Durasi peminjaman: 14 hari • Maksimal 3
                                buku per siswa</small>
                        </div>
                    </div>
                    ...
                    <form action="{{ route('siswa.ajukanPinjam') }}" method="POST" id="formPinjam">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-6">
                                ...
                                <input type="date" class="form-control" name="tenggat_kembali"
                                    value="{{ date('Y-m-d', strtotime('+14 days')) }}">
                            </div>
                        </div>

                        <div class="alert alert-warning border-0"
                            style="background-color: #FFF9C4; border-radius: 10px;">
                        ...
                        <div class="row g-2 mt-4">
                            <div class="col-9">
                                <button type="submit" class="btn btn-submit"><i
                                        class="bi bi-journal-bookmark-fill me-2"></i> Ajukan Peminjaman</button>
                            </div>
                            <div class="col-3">
